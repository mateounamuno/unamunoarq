                    ...
                    <div className="row align-items-stretch about-row">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 mb-40 mb-md-0 bio-text-col" >
                            ...
                            >
                                ...
                                <div className="contact-about-text tp_title_anim" style={{ marginTop: 24 }}>
                                    Arquitecto egresado de la Universidad Nacional de Córdoba (2015), con formación complementaria en la Universidade Federal do Paraná (Brasil).<br />
                                    Completó el curso internacional de posgrado "Livable Future Cities" dictado por la ETH Zürich (Plataforma Virtual EDX), orientado al diseño sostenible y la planificación urbana contemporánea. Actualmente realiza la tesis de la Maestría en Diseño Arquitectónico y Urbano (UNC). En el año 2016 se muda a Paris para realizar una práctica profesional en el estudio Farid Azib Architecte, donde participa también, como parte del equipo con el estudio Atelier O-S Architectes en el desarrollo de 2 concursos.<br />
                                    Fue socio fundador de RARE Estudio Experimental (2019 – 2023). Actualmente es fundador de Unamuno Arquitectura, estudio desde el cual lidera y coordina proyectos residenciales, comerciales y culturales, articulando la práctica proyectual con prácticas artísticas, investigación y docencia. Tiene base física en Alterable, espacio cultural del cual es socio fundador y coordina diferentes actividades ligadas a la cultura local junto con Agustín Willnecker, Ivan Ferrero y Dino Valentini.<br />
                                    ...
                                    Su trabajo fue reconocido por ArchDaily como una de las "Best New Practices 2024", distinción otorgada a diez estudios emergentes de arquitectura a nivel internacional.<br />
